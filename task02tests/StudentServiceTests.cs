...
public class StudentServiceTests
{
    ...
    [Fact]
    public void GroupStudentsByFaculty_CreatesCorrectLookupGroups()
    {
    ...
    [Fact]
    public void GetFacultyWithHighestAverageGrade_ReturnsFacultyWithMaxGrade()
    {
        var bestFaculty = _service.GetFacultyWithHighestAverageGrade();
        Assert.Equal("Экономика", bestFaculty);
    }
}
